...
public class KMeans
{
    ...
    private int TOTAL_DATA = 3;      // Total data points.
    /*
    ...
    */
    ...
    public double[] calculateKmeans(int numClusters, int totalDataCount, double dataPoints[][])
    {
       ...
       //System.out.println("Centroids finalized at:");
        for(int i = 0; i < NUM_CLUSTERS; i++)
        {
            ...
            if (i== NUM_CLUSTERS-1) 
            {
            	data[0]= centroids.get(i).X();
            	data[1]= centroids.get(i).Y();
            }
        }
        //System.out.print("\n");
        return data;
